...
public class InvalidOperation extends TException implements org.apache.thrift.TBase<InvalidOperation, InvalidOperation._Fields>, java.io.Serializable, Cloneable, Comparable<InvalidOperation>, android.os.Parcelable {
  ...
  public InvalidOperation(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.whatOp = in.readInt();
    this.why= in.readString();
  }

  public static final android.os.Parcelable.Creator<InvalidOperation> CREATOR = new android.os.Parcelable.Creator<InvalidOperation>() {
    @Override
    public InvalidOperation[] newArray(int size) {
      return new InvalidOperation[size];
    }

    @Override
    public InvalidOperation createFromParcel(android.os.Parcel in) {
      return new InvalidOperation(in);
    }
  };
