...
;
  ...
  public static class add_args implements org.apache.thrift.TBase<add_args, add_args._Fields>, java.io.Serializable, Cloneable, Comparable<add_args>, android.os.Parcelable   {
    ...
    public add_args(android.os.Parcel in) {
      //primitive bitfield of type: byte
    ...
    public static final android.os.Parcelable.Creator<add_args> CREATOR = new android.os.Parcelable.Creator<add_args>() {
      @Override
      public add_args[] newArray(int size) {
        return new add_args[size];
      }

      @Override
      public add_args createFromParcel(android.os.Parcel in) {
        return new add_args(in);
      }
    };
  ...
  public static class add_result implements org.apache.thrift.TBase<add_result, add_result._Fields>, java.io.Serializable, Cloneable, Comparable<add_result>, android.os.Parcelable   {
    ...
    public add_result(android.os.Parcel in) {
      //primitive bitfield of type: byte
      __isset_bitfield = in.readByte();
    ...
    public static final android.os.Parcelable.Creator<add_result> CREATOR = new android.os.Parcelable.Creator<add_result>() {
      @Override
      public add_result[] newArray(int size) {
        return new add_result[size];
      }

      @Override
      public add_result createFromParcel(android.os.Parcel in) {
        return new add_result(in);
      }
    };
  ...
  public static class calculate_args implements org.apache.thrift.TBase<calculate_args, calculate_args._Fields>, java.io.Serializable, Cloneable, Comparable<calculate_args>, android.os.Parcelable   {
    ...
    public calculate_args(android.os.Parcel in) {
      //primitive bitfield of type: byte
      __isset_bitfield = in.readByte();

      this.logid = in.readInt();
      this.w= in.readParcelable(calculate_args.class.getClassLoader());
    }

    public static final android.os.Parcelable.Creator<calculate_args> CREATOR = new android.os.Parcelable.Creator<calculate_args>() {
      @Override
      public calculate_args[] newArray(int size) {
        return new calculate_args[size];
      }

      @Override
      public calculate_args createFromParcel(android.os.Parcel in) {
        return new calculate_args(in);
      }
    };
  ...
  public static class calculate_result implements org.apache.thrift.TBase<calculate_result, calculate_result._Fields>, java.io.Serializable, Cloneable, Comparable<calculate_result>, android.os.Parcelable   {
    ...
    public calculate_result(android.os.Parcel in) {
      //primitive bitfield of type: byte
      __isset_bitfield = in.readByte();
    ...
    public static final android.os.Parcelable.Creator<calculate_result> CREATOR = new android.os.Parcelable.Creator<calculate_result>() {
      @Override
      public calculate_result[] newArray(int size) {
        return new calculate_result[size];
      }

      @Override
      public calculate_result createFromParcel(android.os.Parcel in) {
        return new calculate_result(in);
      }
    };
  ...
  public static class zip_args implements org.apache.thrift.TBase<zip_args, zip_args._Fields>, java.io.Serializable, Cloneable, Comparable<zip_args>, android.os.Parcelable   {
    ...
    public zip_args(android.os.Parcel in) {
    }

    public static final android.os.Parcelable.Creator<zip_args> CREATOR = new android.os.Parcelable.Creator<zip_args>() {
      @Override
      public zip_args[] newArray(int size) {
        return new zip_args[size];
      }

      @Override
      public zip_args createFromParcel(android.os.Parcel in) {
        return new zip_args(in);
      }
    };
