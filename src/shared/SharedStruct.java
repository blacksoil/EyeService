...
public class SharedStruct implements org.apache.thrift.TBase<SharedStruct, SharedStruct._Fields>, java.io.Serializable, Cloneable, Comparable<SharedStruct>, android.os.Parcelable {
  ...
  public SharedStruct(android.os.Parcel in) {
    //primitive bitfield of type: byte
  ...
  public static final android.os.Parcelable.Creator<SharedStruct> CREATOR = new android.os.Parcelable.Creator<SharedStruct>() {
    @Override
    public SharedStruct[] newArray(int size) {
      return new SharedStruct[size];
    }

    @Override
    public SharedStruct createFromParcel(android.os.Parcel in) {
      return new SharedStruct(in);
    }
  };
